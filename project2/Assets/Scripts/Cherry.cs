...
public class Cherry : MonoBehaviour
{
    ...
    public bool cherryShrinked = false;
    public Logic logic;
    public Orange orange;
    public Lemon lemon;
    public int cherryScore = 3;
    ...
    private bool checkTreasureMove(Vector3 position)
    {
        ...
        if (trap.transform.position == position || orange.transform.position == position || lemon.transform.position == position)
        {
            return false;
        }
